...
const NewProductForm: React.FC = () => {
  ...
  return (
    <div
      className={`flex items-center justify-center p-4 pt-7 xl:pt-10 font-sans`}
    >
      <Card
        className={`w-full max-w-4xl rounded-md bg-white border-gray-200 dark:bg-gray-900 dark:border-gray-600 shadow-xl`}
      >
        <CardHeader className="border-gray-300 dark:border-gray-800">
          <div className="flex justify-between items-center">
            <CardTitle
              className={`font-extrabold text-3xl xl:text-4xl text-gray-900 dark:text-white `}
            >
              Add New Product
            </CardTitle>
          </div>
