  ...
  return (
    <div className="bg-[#F3F9F1]">
      <div className="container max-w-6xl mx-auto px-4 grid grid-cols-3 md:grid-cols-5 gap-5">
        {/* 1 */}
        <div className="h-52  flex flex-col justify-center items-center group">
          <svg
            stroke="currentColor"
            fill="currentColor"
            stroke-width="0"
            viewBox="0 0 32 32"
            className="text-[60px] transition-all text-gray-600 duration-300 group-hover:text-red-400 group-hover:scale-105 group-hover:-translate-y-1 mb-2"
            height="1em"
            width="1em"
          ...
          <h2 className="text-[20px] font-semibold text-black my-2">
            Free Shipping
          </h2>
          <p className="text-gray-800 text-sm">For all Orders Over $100</p>
        </div>
        ...
        <div className="h-52 flex flex-col justify-center items-center group">
          ...
          <p className="text-gray-800 text-sm">For an Exchange Product</p>
        </div>
        ...
        <div className="h-52 flex flex-col justify-center items-center group">
          ...
          <p className="text-gray-800 text-sm">Payment Cards Accepted</p>
        </div>
        ...
        <div className="h-52 flex flex-col justify-center items-center group">
          ...
          <p className="text-gray-800 text-sm">Our First Product Order</p>
        </div>
        ...
        <div className="h-52 flex flex-col justify-center items-center group ">
          ...
          <p className="text-gray-800 text-sm">Contact us Anytime</p>
        </div>
      </div>
    </div>
  );
